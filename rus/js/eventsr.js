const items = [
    { img:'img/jsc.jpg', 
      ...
      description: 'Конкурс стартапов для основателей из региона Жетису, которые ищут решения в AgriTech, TravelTech, Creative Industries.', 
      deadline: ' Июнь 13, 2023', 
      city: 'Талдыкорган', 
      page:'jscr.html',
    ...
    { img:'img/Decentrathon.jpg', 
      title: 'Decentraton', 
      description: 'Приготовьтесь к крупнейшему хакатону Web3 в Центральной Азии - Decentrathon!',
      deadline: ' Июнь 14, 2023', 
      city: 'Aстана', 
    ...
    { img:'img/learning hack.png', 
      ...
      description: 'Главное событие года для разработчиков образовательных продуктов.',
      deadline: ' Июнь 15, 2023', 
      city: 'Aлматы',
      ...
      eventType:'hackathon'},
      {
        ...
        description: 'Это мероприятие для стартапов в сфере Индустрии 4.0',
        deadline: ' Июнь 16, 2023', 
        city: 'Алматы',
        page:'industryr.html',
        eventType:'competition'},
